...
const requiredEnvVars = {
  ...
  // File Upload
  MAX_FILE_SIZE: z.string().transform(Number).pipe(z.number().positive()).default('104857600'),
  ...
  // YouTube
  YTDLP_COOKIES_PATH: z.string().min(1, 'YTDLP_COOKIES_PATH is required').default('./cookies.txt'),
